...
def VendasView(page: ft.Page):
                    ...
                    content=ft.Container(
                        content=ft.Column([
                            ft.ListTile(
                                ...
                                on_click=editar_item
                            ),
                            ft.ListTile(
                                leading=ft.Icon(ft.icons.DELETE, color=Colors.BRAND_RED),
                                title=ft.Text("Remover Item", color=Colors.BRAND_RED),
    ...
    def modal_editar_item(item):
        ...
        modal = ft.AlertDialog(
            modal=True,
            title=ft.Text("Editar Item", size=Sizes.FONT_XLARGE, weight=ft.FontWeight.BOLD),
            content=ft.Container(
                content=ft.Column([
                    ft.Text(f"Produto: {item['descricao']}", size=Sizes.FONT_MEDIUM, weight=ft.FontWeight.BOLD),
                    ft.Divider(),
                    input_quantidade,
                    input_preco,
                    ft.Divider(),
    ...
    def confirmar_remocao_item(item):
        ...
        modal = ft.AlertDialog(
            modal=True,
            title=ft.Text("Remover Item", size=Sizes.FONT_XLARGE, weight=ft.FontWeight.BOLD),
            content=ft.Container(
                content=ft.Column([
                    ft.Icon(ft.icons.WARNING_AMBER, size=60, color=Colors.BRAND_ORANGE),
                    ft.Text(
                    ...
                    ft.Divider(),
                    ft.Text(f"Produto: {item['descricao']}", size=Sizes.FONT_SMALL),
                    ft.Text(f"Quantidade: {item['quantidade']}", size=Sizes.FONT_SMALL),
                    ft.Text(f"Valor: R$ {item['subtotal']:.2f}", size=Sizes.FONT_SMALL, color=Colors.BRAND_RED),
    ...
    def cancelar_venda_concluida_modal(e):
        ...
        def confirmar_cancelamento(e):
            ...
            resultado = VendasAPI.cancelar_venda(int(input_id_venda.value))
            ...
            if resultado:
                ...
                page.snack_bar = ft.SnackBar(
                    content=ft.Text("Erro ao cancelar venda!"),
                    bgcolor=Colors.BRAND_RED,
                )
                page.snack_bar.open = True
                page.update()
        ...
        if not recentes:
            ...
            for venda in recentes:
                ...
                try:
                    ...
                    d = dt.fromisoformat(data_str)
                    data_fmt = d.strftime("%d/%m/%Y")
                    hora_fmt = d.strftime("%H:%M:%S")
                except Exception:
